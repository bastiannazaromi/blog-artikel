			...
			<div class="row">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-end">
						...
						<li class="breadcrumb-item active" aria-current="page">Add Peminjaman</li>
					</ol>
				</div>
			</div>
			<!--end::Row-->
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="card mb-4">
						...
						<div class="card-body">
							<form action="<?= base_url('peminjaman/postAdd'); ?>" method="POST">
								...
								<div class="mb-3">
									...
									<select name="id_buku" class="form-control">
										...
										<?php foreach ($buku as $bk) : ?>
											<option value="<?= $bk->id; ?>" <?= (set_value('id_buku') == $bk->id ? 'selected' : ''); ?>><?= $bk->judul; ?></option>
										<?php endforeach; ?>
									</select>
